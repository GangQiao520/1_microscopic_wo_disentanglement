...
class BatchGenerator(keras.utils.Sequence):
    ...
    def __grab_and_process_single_img(sequence_num, agent_idx, input_sample=True):  # private method
        ...
        if input_sample is True:  # grab x_img
            base_dir = './microscopic_image_samples_all_steps_binary/'
        ...
        # [3] threshold to binary {0, 1}, by swapping labels for both x_img and ground truth y_img
    ...
    def __getitem__(self, batch_index):
        ...
        x_base_dir = './microscopic_image_samples_all_steps_binary/' + 'instance' + str(sequence_num) + '/'
